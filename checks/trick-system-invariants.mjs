...
const requirements=[
 ...
 ['manual backflip can complete when started early',/manual[\s\S]{0,360}(backflip|flip)[\s\S]{0,360}(allow|success|complete)/i],
 ['ramp backflip succeeds',/ramp[\s\S]{0,360}(backflip|flip)[\s\S]{0,360}(success|complete|land)/i],
