...
const requirements=[
 ...
 ['manual 360 can complete',/source='manual'[\s\S]{0,1600}completeActive|completeActive[\s\S]{0,1600}source='manual'/i],
 ['ramp 360 can complete',/armRamp[\s\S]{0,1200}completeActive|completeActive[\s\S]{0,1200}armRamp/i],
 ['manual backflip can complete when started early',/BACKFLIP[\s\S]{0,1800}completeActive|completeActive[\s\S]{0,1800}BACKFLIP/i],
