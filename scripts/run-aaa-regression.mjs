...
const checks=[
  ...
  ['course-collision-lategame','checks/course-collision-lategame-invariants.mjs'],
  ...
  ['leave-backflip-lift','checks/leave-backflip-lift-invariants.mjs'],
  ...
  ['audio','checks/audio-invariants.mjs'],
  ['gamefeel-audio','checks/gamefeel-audio-invariants.mjs'],
  ['audio-haptics','checks/audio-haptics-invariants.mjs'],
  ['controller-menu-haptics','checks/controller-menu-haptics-invariants.mjs'],
  ['menu-input-repeat','checks/menu-input-repeat-invariants.mjs'],
  ['ui-ux-accessibility','checks/ui-ux-invariants.mjs'],
  ['public-smoke-harness','checks/public-smoke-harness-invariants.mjs'],
  ['environment-corridor','checks/environment-corridor-invariants.mjs'],
  ['qa-environment-corridor','checks/qa-environment-corridor-invariants.mjs'],
  ['environment-visual','checks/environment-visual-invariants.mjs'],
  ['mountain-visual','checks/mountain-visual-invariants.mjs'],
  ['powder-snow','checks/powder-snow-invariants.mjs'],
  ['blue-bloom','checks/blue-bloom-invariants.mjs'],
  ...
  ['runtime-state-contract','scripts/audit-runtime-state-contract.mjs'],
