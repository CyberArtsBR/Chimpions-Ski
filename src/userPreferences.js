...
export function loadUserPreferences(){
  return {
    ...
    quality:normalizedChoice(read(KEYS.quality,'auto'),['auto','high','max','max-cinematic','medium','low'],'auto'),
...
export function saveQualityPreference(mode){
  return write(KEYS.quality,normalizedChoice(mode,['auto','high','max','max-cinematic','medium','low'],'auto'));
}
